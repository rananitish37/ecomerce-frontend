import {AccountBalanceWallet, AccountBox, Add, Dashboard, Inventory, LocalShipping, Logout, Receipt } from '@mui/icons-material'
...
const menu=[
    ...
    },
    {
        name: "Orders",
        path: "/seller/orders",
        icon: <LocalShipping className='text-primary-color' />,
        activeIcon: <LocalShipping className='text-white' />
    },
    {
        name: "Products",
